...
public class Gau_RayTracing_Multi : MonoBehaviour
{
    ...
    void Start()
    {
        outputFile1 = Path.Combine(basePath, "EstimateByVoxel_" + "Gau_"  + test_std_azi + "_" + test_std_ele + "_" + raysPerBaseStation + "_" + maxReflections + ".csv");
