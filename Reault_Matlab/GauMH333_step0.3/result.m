...
% file12 = readtable('EstimateByVoxel_Gau_MH_0.2_0.45_1800_3.csv');
file13 = readtable('EstimateByVoxel_Gau_MH_0.2_1_2000_3.csv');
file14 = readtable('EstimateByVoxel_Gau_MH_0.2_1_1800_3.csv');
file15 = readtable('EstimateByVoxel_Gau_MH_0.2_1_1600_3.csv');
...
% plot(x12, f12, '-x', 'DisplayName', 'EstimateByVoxel Gau 0.2 0.45 1800');

[f13, x13] = ecdf(error13);
plot(x13, f13, '-x', 'DisplayName', 'EstimateByVoxel Gau 0.2 1 2000');

[f14, x14] = ecdf(error14);
plot(x14, f14, '-x', 'DisplayName', 'EstimateByVoxel Gau 0.2 1 1800');

[f15, x15] = ecdf(error15);
plot(x15, f15, '-x', 'DisplayName', 'EstimateByVoxel Gau 0.2 1 1600');
% 
