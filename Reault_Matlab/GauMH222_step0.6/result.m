...
file2 = readtable('EstimateByVoxel_Gau_MH_2.5_0.45_1800_3.csv');
% file3 = readtable('EstimateByVoxel_Gau_MH_2.5_0.45_2000_3.csv');
file4 = readtable('EstimateByVoxel_Gau_MH_2.5_0.45_1600_3.csv');
file5 = readtable('EstimateByVoxel_Gau_MH_2_0.45_1600_3.csv');
file6 = readtable('EstimateByVoxel_Gau_MH_3_0.45_1600_3.csv');
file7 = readtable('EstimateByVoxel_Gau_MH_2_0.45_1400_3.csv');
...
% file14 = readtable('EstimateByVoxel_Gau_MH_0.32_2_1800_3.csv');
...
[f2, x2] = ecdf(error2);
plot(x2, f2, '-o', 'DisplayName', 'EstimateByVoxel Gau MH 2.5 0.45');

% [f3, x3] = ecdf(error3);
% plot(x3, f3, '-x', 'DisplayName', 'EstimateByVoxel Gau MH 2 0.45 2000');

[f4, x4] = ecdf(error4);
plot(x4, f4, '-x', 'DisplayName', 'EstimateByVoxel Gau MH 2.5 0.45 1600');

[f5, x5] = ecdf(error5);
plot(x5, f5, '-o', 'DisplayName', 'EstimateByVoxel Gau MH 2 0.45 1600');

[f6, x6] = ecdf(error6);
plot(x6, f6, '-o', 'DisplayName', 'EstimateByVoxel Gau MH 3 0.45 1600');

[f7, x7] = ecdf(error7);
plot(x7, f7, '-x', 'DisplayName', 'EstimateByVoxel Gau MH 2 0.45 1400');
...
% plot(x14, f14, '-x', 'DisplayName', 'EstimateByVoxel Gau 0.32 2');
