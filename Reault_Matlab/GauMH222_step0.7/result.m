...
file2 = readtable('EstimateByVoxel_Gau_MH_2.5_0.45_2000_3.csv');
% file3 = readtable('EstimateByVoxel_Gau_MH_2.5_0.32_2000_3.csv');
% file4 = readtable('EstimateByVoxel_Gau_MH_2.5_1_1800_3.csv');
...
[f3, x3] = ecdf(error3);
plot(x3, f3, '-x', 'DisplayName', 'EstimateByVoxel Gau MH 2.5 0.32');

% [f4, x4] = ecdf(error4);
% plot(x4, f4, '-x', 'DisplayName', 'EstimateByVoxel Gau MH 2.5 1');
