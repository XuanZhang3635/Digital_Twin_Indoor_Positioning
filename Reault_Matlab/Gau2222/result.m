...
file11 = readtable('EstimateByVoxel_Gau_2.34_0.2_1800_3.csv');

file12 = readtable('EstimateByVoxel_Gau_2.34_0.7_1800_3.csv');

file13 = readtable('EstimateByVoxel_Gau_2.5_0.45_1800_3.csv');

file14 = readtable('EstimateByVoxel_Gau_3_0.45_1800_3.csv');
...
plot(x11, f11, '-x', 'DisplayName', 'EstimateByVoxel Gau 2.34 0.2');

[f12, x12] = ecdf(error12);
plot(x12, f12, '-x', 'DisplayName', 'EstimateByVoxel Gau 2.34 0.7');

[f13, x13] = ecdf(error13);
plot(x13, f13, '-x', 'DisplayName', 'EstimateByVoxel Gau 2.5 0.45');

[f14, x14] = ecdf(error14);
plot(x14, f14, '-x', 'DisplayName', 'EstimateByVoxel Gau 3 0.45');
